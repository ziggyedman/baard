...
const socials = [
  {
    ...
    label: "Instagram",
    handle: "@ziggyedman",
    href: "https://www.instagram.com/ziggyedman/",
    color: "#E1306C",
  },
  {
    icon: FaLinkedinIn,
    label: "LinkedIn",
    handle: "michaelvaz",
    href: "https://www.linkedin.com/in/michaelvaz/",
    color: "#0A66C2",
  },
  {
    icon: FaXTwitter,
    label: "X / Twitter",
    handle: "@ziggyedman",
    href: "https://x.com/ziggyedman",
    color: "#ffffff",
  },
  {
    icon: FaFacebook,
    label: "Facebook",
    handle: "themichaelvaz",
    href: "https://www.facebook.com/themichaelvaz",
    color: "#1877F2",
  },
  {
    icon: FaGithub,
